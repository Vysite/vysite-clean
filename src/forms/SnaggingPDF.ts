...
const CSS = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .kpi-label { font-size: 8.5px; font-weight: 700; color: #475569; text-transform: uppercase; letter-spacing: 0.07em; margin-top: 4px; }
  ...
  .progress-label { font-size: 9px; font-weight: 700; color: #334155; text-transform: uppercase; letter-spacing: 0.07em; margin-bottom: 5px; display: flex; justify-content: space-between; }
  ...
  /* ── Section heading ── */
  .section-heading { font-size: 8.5px; font-weight: 800; color: #334155; text-transform: uppercase; letter-spacing: 0.1em; padding-bottom: 6px; border-bottom: 1.5px solid #e2e8f0; margin-bottom: 12px; margin-top: 24px; }
  ...
  .snag-number { font-family: monospace; font-size: 10px; font-weight: 700; color: #334155; background: #f1f5f9; padding: 3px 8px; border-radius: 5px; }
  ...
  .data-cell-label { font-size: 7.5px; font-weight: 700; color: #475569; text-transform: uppercase; letter-spacing: 0.07em; margin-bottom: 2px; }
  ...
  .text-field-label { font-size: 7.5px; font-weight: 700; color: #475569; text-transform: uppercase; letter-spacing: 0.07em; margin-bottom: 3px; }
  .text-field-value { font-size: 10.5px; color: #1e293b; line-height: 1.6; white-space: pre-wrap; }

  /* ── Comments ── */
  .comment { background: #f8fafc; border-left: 3px solid #e2e8f0; border-radius: 0 5px 5px 0; padding: 7px 10px; margin-bottom: 5px; font-size: 10px; color: #1e293b; }
  ...
  .badge-low      { background: #f1f5f9; color: #1e293b; }
  ...
  .photo-caption { padding: 5px 9px; font-size: 9px; color: #334155; background: #f8fafc; border-top: 1px solid #e2e8f0; }
    ...
    ${images.map(img => `
      <div class="photo-item">
        ${img.data_url
          ...
          : `<div class="photo-img" style="min-height:120px;display:flex;align-items:center;justify-content:center;color:#475569;font-size:10px">Photo unavailable</div>`
        }
...
export function buildSnaggingReportPageHTML(
  ...
  const snagItemsHtml = snags.length
    ...
    : `<div style="text-align:center;padding:32px;color:#475569;font-size:12px;">No snag items in this report.</div>`;
       ...
       <table style="width:100%;border-collapse:collapse;font-size:10px;margin-bottom:20px">
         <thead>
           <tr style="background:#f1f5f9;border-bottom:2px solid #e2e8f0">
             <th style="padding:8px 10px;text-align:left;font-size:9px;font-weight:700;color:#1e293b;text-transform:uppercase;letter-spacing:.05em">Ref</th>
             <th style="padding:8px 10px;text-align:left;font-size:9px;font-weight:700;color:#1e293b;text-transform:uppercase;letter-spacing:.05em">Title</th>
             <th style="padding:8px 10px;text-align:left;font-size:9px;font-weight:700;color:#1e293b;text-transform:uppercase;letter-spacing:.05em">Location</th>
             <th style="padding:8px 10px;text-align:left;font-size:9px;font-weight:700;color:#1e293b;text-transform:uppercase;letter-spacing:.05em">Trade</th>
             <th style="padding:8px 10px;text-align:left;font-size:9px;font-weight:700;color:#1e293b;text-transform:uppercase;letter-spacing:.05em">Priority</th>
             <th style="padding:8px 10px;text-align:left;font-size:9px;font-weight:700;color:#1e293b;text-transform:uppercase;letter-spacing:.05em">Status</th>
             <th style="padding:8px 10px;text-align:left;font-size:9px;font-weight:700;color:#1e293b;text-transform:uppercase;letter-spacing:.05em">Responsible</th>
             <th style="padding:8px 10px;text-align:left;font-size:9px;font-weight:700;color:#1e293b;text-transform:uppercase;letter-spacing:.05em">Due Date</th>
           </tr>
         </thead>
         <tbody>
           ${snags.map((s, i) => {
             ...
             return `<tr style="${i % 2 === 1 ? 'background:#f8fafc' : ''}">
               <td style="padding:7px 10px;border-bottom:1px solid #f1f5f9;font-family:monospace;font-size:9.5px;color:#334155">${esc(num)}</td>
               <td style="padding:7px 10px;border-bottom:1px solid #f1f5f9;font-weight:600;max-width:180px">${esc(s.title)}</td>
               <td style="padding:7px 10px;border-bottom:1px solid #f1f5f9;color:#1e293b">${esc(s.location ?? '—')}</td>
               <td style="padding:7px 10px;border-bottom:1px solid #f1f5f9;color:#1e293b">${esc(s.trade ?? '—')}</td>
               ...
               <td style="padding:7px 10px;border-bottom:1px solid #f1f5f9;color:#1e293b">${esc(s.responsibleParty ?? '—')}</td>
               <td style="padding:7px 10px;border-bottom:1px solid #f1f5f9;color:${isDue ? '#dc2626' : '#1e293b'};font-weight:${isDue ? '700' : '400'}">${fmtDate(s.dueDate)}</td>
             </tr>`;
           }).join('')}
         </tbody>
       </table>`
