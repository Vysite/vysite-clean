...
const PRODUCTION_HOSTNAME = 'app.vysite.com';

function resolveEnv(): AppEnv {
  // Runtime hostname always wins — prevents a staging build from showing the
  // banner on the production domain if the wrong build command was used.
