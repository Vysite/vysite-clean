      ...
      <div className="flex items-start justify-between gap-4">
        ...
        {canCreate && (
          <button onClick={() => setShowNewReport(true)}
            className="flex items-center gap-2 bg-[#f97316] text-white px-4 py-2.5 rounded-lg text-sm font-semibold hover:bg-orange-600 transition-colors shrink-0">
            ...
            {filtered.map(report => {
              ...
              return (
                <div key={report.id}
                  ...
                  className="bg-[#1a2236] border border-[#1e2d4a] rounded-xl p-4 hover:border-slate-500/60 hover:bg-[#1e2840] transition-all cursor-pointer group">
